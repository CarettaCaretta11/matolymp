...
urlpatterns = [
    ...
    re_path(r"^comments/(?P<thread_id>[0-9]+)/edit/$", views.update_submission, name="update_post"),
    re_path(r"^comments/(?P<thread_id>[0-9]+)/delete/$", views.delete_submission, name="delete_post"),
